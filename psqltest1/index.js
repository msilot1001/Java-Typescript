...
async function DB_Connect() {
    const pg = new Client({
        ...
        database: 'ddndpaaev1f99f',
        password: 'd99ca263e02e4c8f700978deb0152a4a46127f6d667bc4d7dc6c8ee31ea1cac8',
        port: 5432,
        ssl: {
    ...
    try {
        await pg.connect(err => {
            ...
            else { console.log('Psql connect success'); queryDatabase(); /*Interface_Home();*/ }
        });
    }
